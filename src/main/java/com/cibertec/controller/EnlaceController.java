...
public class EnlaceController {
	...
	public String verRegistraMarca() {
	...
	public String verRegistroSede() {
		return "intranetRegistroSede";
	}

	@RequestMapping("/verRegistroUsuario")
	public String verRegistroUsuario() {
		return "intranetRegistroUsuario";
	}

	@RequestMapping("/verRegistroTipoReclamo")
	public String verRegistroTipoReclamo() {
		return "intranetRegistroTipoReclamo";
	}

	@RequestMapping("/verRegistroPais")
	public String verRegistroPais() {
		return "intranetRegistroPais";
	}
}
